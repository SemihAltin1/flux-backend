...
class BulkUpdateNotesRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'notes.*.id' => ['required', 'integer', 'exists:notes,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'notes.*.id.required' => 'Each note must have an ID',
            'notes.*.id.exists' => 'Note ID does not exist',
